------------------------------------------------------------------------------
-- plbv46_mbref_mio.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
library plbv46_mbref_mio_v1_00_a;
use plbv46_mbref_mio_v1_00_a.user_logic;
...
end entity plbv46_mbref_mio;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of plbv46_mbref_mio is
  ...
  constant IPIF_ARD_NUM_CE_ARRAY          : INTEGER_ARRAY_TYPE   := 
    (
      ...
      5  => 1                             -- number of ce for user logic memory space 3 (always 1 chip enable)
    );
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity plbv46_mbref_mio_v1_00_a.user_logic
    generic map
    (
  ...
  begin
    ...
    case ipif_Bus2IP_CS is
      when "100000" => ipif_IP2Bus_Data <= (others => '0');
      when "010000" => ipif_IP2Bus_Data <= intr_IP2Bus_Data;
      when "001000" => ipif_IP2Bus_Data <= user_IP2Bus_Data;
  ...
  ipif_IP2Bus_WrAck <= rst_IP2Bus_WrAck or intr_IP2Bus_WrAck or user_IP2Bus_WrAck;
  ipif_IP2Bus_RdAck <= intr_IP2Bus_RdAck or user_IP2Bus_RdAck;
  ipif_IP2Bus_Error <= rst_IP2Bus_Error or intr_IP2Bus_Error or user_IP2Bus_Error;
